function transLaplaceCero(a,b,ciy,cix,xi,t0)
...
mensaje('Representa la respuesta de la entrada cero')
...
subplot(2,2,3)
hold on 
title('Respuesta a entrada cero del sistema','FontWeight','bold','FontSize',14)
